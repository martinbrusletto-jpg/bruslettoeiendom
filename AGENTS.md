# Agent instructions for Martin

Read `AI_OS.md` first and follow it as the canonical operating system for work in this repository.
...
Do not turn one-off project constraints into permanent preferences unless the pattern repeats or Martin explicitly says it should be permanent.